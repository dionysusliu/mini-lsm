...
type LsmIteratorInner = TwoMergeIterator<
    MergeIterator<MemTableIterator>, // memtable
    TwoMergeIterator<
        MergeIterator<SsTableIterator>,   // L0 sstable
        MergeIterator<SstConcatIterator>, // L1~Ln sstables
    >,
>;
...
impl<I: StorageIterator> StorageIterator for FusedIterator<I> {
    ...
    fn next(&mut self) -> Result<()> {
        if self.has_errored {
            return Err(anyhow::anyhow!("Calling next() on invalid iterator!"));
        }
